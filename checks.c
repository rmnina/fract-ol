...
/*   Updated: 2023/09/28 00:25:54 by jdufour          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (argv[1] && (ft_strncmp(argv[1], "Mandelbar", 10) == 0 || ft_strncmp(argv[1], "mandelbar", 10) == 0))
        return (1);
    return (0);
}
...
{
	 if (argv[1] && (ft_strncmp(argv[1], "Burningship", 12) == 0 || ft_strncmp(argv[1], "burningship", 12) == 0))
        return (1);
    return (0);
}
